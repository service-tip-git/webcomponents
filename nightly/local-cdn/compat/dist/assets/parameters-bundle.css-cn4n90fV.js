const _=`:host {
    ...
    --_ui5_slider_progress_before_border: solid .0625rem var(--sapContent_MeasureIndicatorColor);
    --_ui5_slider_progress_after_border: solid .0625rem var(--sapContent_Selected_MeasureIndicatorColor);
    ...
    --_ui5_slider_inner_height: .375rem;
    --_ui5_slider_inner_min_width: 4rem;
    --_ui5_slider_outer_height: var(--_ui5-compact-size, 1.3125rem)  var(--_ui5-cozy-size, calc(var(--_ui5_slider_handle_height) + 9px));
    ...
    --_ui5_slider_handle_border: .0625rem solid var(--sapField_BorderColor);
    ...
    --_ui5_slider_track_total_height: var(--_ui5-light-scheme, var(--_ui5-compact-size, var(--_ui5_slider_inner_height))  var(--_ui5-cozy-size, var(--_ui5_slider_inner_height))) var(--_ui5-dark-scheme, var(--_ui5_slider_inner_height));
    --_ui5_slider_handle_top: var(--_ui5-compact-size, calc((var(--_ui5_slider_track_total_height) - var(--_ui5_slider_handle_height)) / 2))  var(--_ui5-cozy-size, calc((var(--_ui5_slider_track_total_height) - var(--_ui5_slider_handle_height)) / 2));
    ...
    --_ui5_slider_handle_focus_border: .125rem solid var(--sapField_BorderColor);
    ...
    --_ui5_slider_progress_outline_offset: var(--_ui5-compact-size, -.625rem)  var(--_ui5-cozy-size, -14px);
    ...
    --_ui5_slider_tooltip_border: .0625rem solid var(--_ui5_slider_tooltip_border_color);
    --_ui5_slider_tooltip_box_shadow: none;
    --_ui5_slider_tooltip_padding: var(--_ui5-compact-size, .25rem)  var(--_ui5-cozy-size, .25rem);
    --_ui5_slider_tooltip_height: var(--_ui5-compact-size, 1rem)  var(--_ui5-cozy-size, 1.375rem);
    ...
    --_ui5_range_slider_progress_focus_top: calc(-1 * ((var(--_ui5_slider_handle_height) / 2) + .1875rem) + 2 * var(--_ui5_slider_progress_border_width));
    ...
    --_ui5_slider_start_end_point_top: -.125rem;
    ...
    --_ui5_range_slider_focus_outline_width: var(--_ui5-compact-size, calc(100% + var(--_ui5_slider_handle_width) + 12px))  var(--_ui5-cozy-size, calc(100% + var(--_ui5_slider_handle_width) + 12px));
    --_ui5_slider_progress_outline_offset_left: var(--_ui5-compact-size, calc(-1 * (var(--_ui5_slider_handle_width) / 2) - 6px))  var(--_ui5-cozy-size, calc(-1 * (var(--_ui5_slider_handle_width) / 2) - 6px));
