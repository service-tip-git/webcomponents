...
export default function DayPickerTemplate() {
    return (_jsx("div", { class: {
        ...
        }, onKeyDown: this._onkeydown, onKeyUp: this._onkeyup, onMouseDown: this._onmousedown, onClick: this._onclick, onMouseOver: this._onmouseover, children: _jsxs("div", { id: `${this._id}-content`, class: "ui5-dp-content", role: "grid", "aria-roledescription": this.ariaRoledescription, children: [_jsx("div", { role: "row", class: "ui5-dp-days-names-container", children: this._dayNames.map(day => _jsx("div", { role: "columnheader", "aria-label": day.ultraShortName ? day.name : undefined, class: day.classes, children: day.ultraShortName ? day.ultraShortName : _jsx("span", { class: "ui5-hidden-text", children: day.name }) })) }), this._weeks.map(week => {
