...
function ViewSettingsDialogFilterTemplate() {
    return (_jsx(_Fragment, { children: this._filterStepTwo ? (_jsx(List, { selectionMode: "Multiple", onSelectionChange: this._handleFilterValueItemClick, "filter-options": "", accessibleNameRef: `${this._id}-label`, children: this._currentSettings.filters.filter(item => item.selected).map(item => (_jsx(_Fragment, { children: item.filterOptions.map(option => (_jsx(ListItemStandard, { selected: option.selected, children: option.text }))) }))) })) : ( // else
        _jsx(List, { onItemClick: this._changeCurrentFilter, "filter-list": "", accessibleNameRef: `${this._id}-label`, children: _jsx(ListItemGroup, { headerText: this._filterByLabel, children: this.filterItems.map(item => (_jsx(ListItemStandard, { class: "ui5-vsd-filterItemList", 
