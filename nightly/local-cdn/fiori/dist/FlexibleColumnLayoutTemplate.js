...
function arrowStart() {
    return (_jsx(Button, { icon: this.startArrowDirection === "backward" ? slimdArrowLefttIcon : slimdArrowRightIcon, design: "Transparent", onClick: this.switchLayoutOnArrowPress, onKeyDown: this._onArrowKeydown, class: "ui5-fcl-arrow ui5-fcl-arrow--start", tooltip: this.accStartArrowText }));
}
function gripStart() {
