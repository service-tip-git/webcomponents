...
export default function ShellBarItemTemplate() {
    if (this.inOverflow) {
        return (_jsx(ListItemStandard, { icon: this.icon ? `sap-icon://${this.icon}` : "", type: "Active", text: this.text, wrappingType: "Normal", additionalText: this.count, "data-ui5-stable": this.stableDomRef, accessibilityAttributes: this.accessibilityAttributes, onClick: this.fireClickEvent }));
    }
